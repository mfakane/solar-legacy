		...
		static Settings()
		{
			if (File.Exists(FileName))
				try
				{
					...
					text = text.Replace("clr-namespace:Ignition.Presentation;assembly=Ignition.Presentation", "clr-namespace:Ignition.Collections;assembly=Ignition.Presentation");
					Default = (Settings)XamlServices.Parse(text);
				}
...
#pragma warning restore 1591
	...
	public class InterfaceSettings
	{
		...
		/// <summary>
		/// アイコンキャッシュの場所を取得または設定します。
		/// </summary>
		public string IconCacheLocation
		{
			get;
			set;
		}
